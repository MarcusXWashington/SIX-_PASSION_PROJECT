...
In order to begin the game. Make sure you have a terminal open in your ide and that you are accessing the proper folder.
...
Once the file is accessed, there will be a brief background for the game displayed and then a line at the end that prompts you to enter "Start" in order to start the game. Once "Start" is entered the game will begin.
